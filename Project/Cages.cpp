...
Forest::Forest(const Forest & other) : Cage(other)
{}
...
Savanna::Savanna(const Savanna & other) : Cage(other)
{}

Savanna & Savanna::operator=(const Savanna & other) {
...
Jungle::Jungle(const Jungle & other) : Cage(other)
{}

Jungle & Jungle::operator=(const Jungle & other) {
...
ArcticZone::ArcticZone(const ArcticZone & other) : Cage(other)
{}

ArcticZone & ArcticZone::operator=(const ArcticZone & other) {
...
Aquarium::Aquarium(const Aquarium & other) : Cage(other)
{}
...
Terrarium::Terrarium(const Terrarium & other) : Cage(other)
{}

Terrarium & Terrarium::operator=(const Terrarium & other) {
